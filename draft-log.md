# Draft Log — Garse and the Guys (2026)
...
| Round | Pick # | Player | Pos | Team | Notes |
|---|---|---|---|---|---|
...
## Live Notes / Reminders
- Positions still needed: (update as draft progresses)
- Bench/bye-week conflicts to watch: (fill in once roster takes shape)
