...
Pick the approach based on where you actually land once your slot is assigned — "context beats philosophy."

| Strategy | What it means | Best when | Risk |
|---|---|---|---|
| **Zero-RB** | Load up WR/elite-TE/QB early, wait on RB, then grab 4-5 RB lottery tickets rounds 6+ | You pick outside the top tier of true 3-down RBs, or you're committed to being very active on waivers all season | High variance — needs weekly waiver diligence; a bad run of RB injuries/committees can tank you |
...
Once base roster is filled: prioritize (a) backup RBs on committees who'd inherit a workhorse role on injury, (b) rookie WRs already carrying real target share, (c) a second streaming-caliber DEF/K only if bye weeks demand it — otherwise use those last picks for upside, not another kicker.
